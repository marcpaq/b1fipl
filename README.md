...
[Tiny Prolog in OCaml](https://github.com/Naereen/Tiny-Prolog-in-OCaml) is a tiny implementation of a small subset of the Prolog language, in OCaml, implemented by [Lilian Besson (@Naereen)](https://github.com/Naereen/)
